...
class FeedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bookPosts = listOf(
            BookPost("Book 1", 5, "Description 1", "https://example.com/image1.jpg", "https://example.com/image1.jpg", "2024-08-12","user1"),
            BookPost("Book 2", 4, "Description 2", "https://example.com/image2.jpg", "https://example.com/image2.jpg", "2023-05-06","user2")
